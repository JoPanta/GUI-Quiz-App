...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain, quiz_score):
        ...
        self.true_button = Button(image=true, highlightthickness=0, bd=0, command=self.answer_true)
        self.true_button.grid(row=2, column=0)

        self.false_button = Button(image=false, highlightthickness=0, bd=0, command=self.answer_false)
